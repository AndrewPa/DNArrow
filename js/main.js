...
window.onload = function initQueryDOM() {
    window.preloaded = {
        ...
        // sizes are from character count of raw D. melanogaster genome files from flybase.net
        // ftp://ftp.flybase.net/genomes/Drosophila_melanogaster/dmel_r5.51_FB2013_03/
        chrom_sizes: {
            '2L': 23011546,
            '2R': 21146710,
            '3L': 24543559,
    ...
    for (var s_dataset in window.preloaded.dataset) {
        window.preloaded.dataset[s_dataset] = new SubDataset();

        for (var t_s_dataset in window.preloaded.input_types) {
